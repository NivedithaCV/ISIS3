...
namespace Isis {
  ...
  void eis2isis(UserInterface &ui) {
    ...
    try {
      ...
      else if (instrumentNameString == "chandrayaan 2") {
  ...
  void translateCoreInfo(FileName &inputLabel, ProcessImport &importer) {
    ...
    FileName transFile = "$ISISROOT/appdata/translations/ClipperEisCore_test.trn";
  ...
  */
  void translateEISLabels(FileName &inputLabel, Pvl *outputLabel) {
    ...
    translateLabels(inputLabel, outputLabel, FileName("$ISISROOT/appdata/translations/chandrayaan2IIRSinstrument.trn"));
  }
